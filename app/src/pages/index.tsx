...
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>Desafio Watt.IO - André Cabral</title>
            </Head>
                ...
                <section className="bg-cinza-3 p-40px ">
                    <div className="text-center ">
                        ...
                        <p className="mt-20px">
                            ...
                            casas/empresas com sistemas de geração, e vendem para os consumidores a preços mais
                            acessíveis do que os das distribuidoras convencionais.
                        </p>
                        <p className="mt-20px">
                            Descubra a opção mais vantajosa dentre as Cooperativas de Energia disponíveis no Brasil e
                            faça sua contratação agora mesmo!
                        </p>
                    </div>
